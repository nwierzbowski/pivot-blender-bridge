...
cdef public int pivot_pro = SPLATTER_EDITION_PRO # type: ignore this exists in a generated file
cdef public int pivot_standard = SPLATTER_EDITION_STANDARD # type: ignore this exists in a generated file

def is_pro_edition() -> bool:
    return bool(SPLATTER_EDITION_PRO)

def is_standard_edition() -> bool:
    return bool(SPLATTER_EDITION_STANDARD)
